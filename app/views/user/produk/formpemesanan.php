        ...
        <div class="container2">
            <div class="box1">
                <div class="input">
                    <h3> Nama Penyewa</h3>
                    <div class="logo">
                        <iconify-icon icon="iconamoon:profile-circle-thin" width="35" height="35"></iconify-icon></iconify-icon>
                ...
                <div class="input">
                    <h3> Email</h3>
                    <div class="logo">
                        <iconify-icon icon="mdi-light:email" width="35" height="35"></iconify-icon>
                ...
                <div class="input">
                    <h3> Nama Rental</h3>
                    <div class="logo">
                        <iconify-icon icon="arcticons:car" width="35" height="35"></iconify-icon>
                ...
                <div class="input">
                    <h3> Lokasi</h3>
                    <div class="logo">
                        <iconify-icon icon="system-uicons:location" width="35" height="35"></iconify-icon>
                ...
                <div class="input">
                    <h3>No Telepon</h3>
                    <div class="logo">
                        <iconify-icon icon="fluent:call-20-regular" width="35" height="35"></iconify-icon>
                ...
                <div class="input">
                    <h3>Harga Sewa</h3>
                    <div class="logo">
                        <iconify-icon icon="ph:money-thin" width="35" height="35"></iconify-icon>
