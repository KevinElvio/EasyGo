...
<body>
    ...
    <div class="box-profile">
        ...
        <div class="keterangan">
            ...
            <a class="logout" href="<?= BASEURL; ?>/?controller=logout" onclick="return confirm('Anda yakin ingin Logout dari akun admin?')"><iconify-icon icon="tabler:logout" style="color: #004aad;"></iconify-icon></a>
